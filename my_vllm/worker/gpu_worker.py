        ...
        self.memory_profile.update(
            {
                ...
                "allocated_after_kv_bytes": torch.cuda.memory_allocated(self.device),
                "reserved_after_kv_bytes": torch.cuda.memory_reserved(self.device),
            }
        )
        logger.info(
